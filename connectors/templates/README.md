...
|------|---------|-----------|
| `rest_connector_template.py` | REST / SDK-driven platform | `connectors.base.Connector` |
| `cli_connector_template.py`  | First-class CLI-driven platform | `connectors.cli_base.CliConnector` |
